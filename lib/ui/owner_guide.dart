            ...
            if (_folded)
              ...
              if (!Fee.exempt)
                step('6', '모임 이용권을 결제하세요',
                    ...
                    /* ⚠️ 예전 문구 「결제 전에도 먼저 만들어 보실 수 있습니다」는 사실이 아니었다 —
                          새 모임은 이용권이 없으면 바로 잠겨 대화·일정·회비·게시판을 «새로 쓰는 것»이
                          서버에서 막힌다(firestore.rules 의 clubPaid). 회원 승인·설정만 된다(2026-09-25 조사). */
                    '· 결제 전에도 회원 승인·설정은 됩니다. 대화·일정·회비 기록·게시판은 결제한 뒤부터 쓸 수 있어요.\n'

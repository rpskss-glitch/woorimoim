...
class WaitScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      /* ⚠️ **밀려 내려갈 수 있어야 한다.**
         글자를 키운 회원(이 앱은 중장년이 많다)이 좁은 폰으로 보면 세로로 139px 넘쳤고,
         넘친 자리에 있던 「가입 신청 취소하기」를 **아예 못 눌렀다**(2026-08-30 실측).
         승인만 기다리는 화면이라 취소가 유일한 출구인데, 그 출구가 막힌 셈이다.
         ⚠️ 가운데 두기는 «내용이 짧을 때»만 뜻이 있다 — 길어지면 위부터 보여야 한다.
            그래서 화면 높이만큼 최소 높이를 주고 그 안에서 가운데 둔다. */
      body: SafeArea(
        child: LayoutBuilder(
  ...
  Future<void> _cancel(BuildContext context, AppState st) async {
